...
class ExpenseController extends Controller
{
    ...
    //     // ── KPIs ─────────────────────────────────────────────────────────────
    //     $totalRevenue  = Invoice::whereBetween('issued_at', [$start, $end])->sum('total_amount');
    ...
    //     // ── Graphique CA vs Dépenses (par jour / semaine / mois) ────────────
    //     if ($period === 'week') {
    ...
    //             fn($d) =>
    //             (float) Invoice::whereDate('issued_at', $d->toDateString())->sum('total_amount')
    //         )->toArray();
    //         $chartExpenses = $days->map(
    //             fn($d) =>
    //             (float) Expense::whereDate('expense_date', $d->toDateString())->sum('amount')
    //         )->toArray();
    //     } elseif ($period === 'month') {
    //         // Par semaine du mois
    ...
    //             fn($m) =>
    //             (float) Invoice::whereYear('issued_at', $m->year)
    //                 ->whereMonth('issued_at', $m->month)->sum('total_amount')
    //         )->toArray();
    //         $chartExpenses = $months->map(
    //             fn($m) =>
    //             (float) Expense::whereYear('expense_date', $m->year)
    //                 ->whereMonth('expense_date', $m->month)->sum('amount')
    //         )->toArray();
    //     }
